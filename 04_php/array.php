...
echo "Daftar nilai mahasiswa yang lulus: " . implode(', ', $nilaiLulus) . "<br>";
...
echo "Daftar karyawan dengan pengalaman kerja lebih dari 5 tahun: " . implode(', ', $karyawabPengalamanLimaTahun) . "<br>";
